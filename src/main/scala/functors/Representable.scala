...
import functors.glue.RepresentableComponent
...
trait Representable[G[_,_], F[_], A] extends RepresentableComponent[G, F, A]

object Representable {

    def apply[G[_,_], F[_], A](implicit instance: Representable[G, F, A]): Representable[G, F, A] = instance

    object Ops {
 
        implicit class toRepresentable[G[_,_], F[_], A](self: F[A])(implicit tc: Representable[G, F, A]) extends RepresentableComponent.Ops[G, F, A] { 
